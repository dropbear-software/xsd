...
import 'package:xsd/src/types/year_month.dart'; // Adjust import path as necessary
  ...
  group('YearMonth', () {
    group('Constructor and Properties', () {
      ...
      test('should throw ArgumentError for invalid timezone offset', () {
        expect(
          () => YearMonth(2023, 10, timezoneOffsetInMinutes: -15 * 60),
          throwsArgumentError,
        );
        expect(
          () => YearMonth(2023, 10, timezoneOffsetInMinutes: 15 * 60),
    ...
    group('Parsing', () {
      ...
      test(
        'should parse valid gYearMonth string with positive timezone offset',
        () {
      ...
      test(
        'should parse valid gYearMonth string with negative timezone offset',
        () {
      ...
      test(
        'should parse valid gYearMonth string with 14:00 timezone offset',
        () {
      ...
      test('should throw FormatException for invalid format', () {
        ...
        expect(() => YearMonth.parse("2023-10-15:00"), throwsFormatException);
        expect(() => YearMonth.parse("101-01"), throwsFormatException);
        expect(() => YearMonth.parse("2013Z"), throwsFormatException);
      });
    });
    ...
    group('toString()', () {
      ...
      test('should return canonical format with Z timezone', () {
        expect(
          YearMonth(2023, 9, timezoneOffsetInMinutes: 0).toString(),
          "2023-09Z",
        );
      });
