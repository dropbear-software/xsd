...
import 'package:xsd/src/year_month.dart';
  ...
  group('YearMonthCodec', () {
    ...
    group('decode', () {
      ...
      test(
        ...
        expect(
            result, equals(YearMonth(2000, 2, timezoneOffsetInMinutes: 330)));
      });
      ...
      test(
        ...
        expect(
            result, equals(YearMonth(0, 1, timezoneOffsetInMinutes: -480)));
      });
      ...
      test('should throw FormatException for invalid format', () {
        ...
        expect(() => codec.decode("2023-10+5:30"), throwsFormatException); // missing 0 in hour
    ...
    group('fuse', () {
      test('decode.fuse(encode) should be identity for valid YearMonth', () {
       ...
       test('decode.fuse(encode) should be identity for YearMonth without timezone', () {
