  ...
  group('XsdNmtokenCodec', () {
    ...
    group('decoder', () {
      ...
      test('should decode NIST provided examples', () {
        expect(
          codec.decode('under.the_digital-among-calle'),
          'under.the_digital-among-calle',
        );
        expect(
          codec.decode('and_is_that_use:issues:data.t'),
          'and_is_that_use:issues:data.t',
        );
        expect(
          codec.decode('is-OASIS.of_related_wide-file'),
          'is-OASIS.of_related_wide-file',
        );
        expect(
          codec.decode('and_and-design-defines_first_'),
          'and_and-design-defines_first_',
        );
        expect(
          codec.decode('and_operating:and.effectively'),
          'and_operating:and.effectively',
        );
        expect(
          codec.decode('Internet_will:_that:to_mad'),
          'Internet_will:_that:to_mad',
        );
        expect(
          codec.decode('launching.correctness_revisions_and.sp'),
          'launching.correctness_revisions_and.sp',
        );
        expect(
          codec.decode('computing-NSRL.can:a.to-of:must-perv'),
          'computing-NSRL.can:a.to-of:must-perv',
        );
        expect(
          codec.decode('that.cost_Business-for_are:industries:processes_pico-'),
        ...
        expect(
          codec.decode('led:back:must.ITL_applications:excha'),
        ...
        expect(
          codec.decode('cost:on:and_available-will.to:must.tune:creati'),
        ...
        expect(
          codec.decode('needed:as-is.Furthermore_retrieve-to.means.find'),
          'needed:as-is.Furthermore_retrieve-to.means.find',
        );
        expect(
          codec.decode('the_United-development-and-each-disco'),
        ...
        expect(
          codec.decode('than:business:ebXML-of:for.of_electronic.diagnosti'),
          'than:business:ebXML-of:for.of_electronic.diagnosti',
        );
        expect(
          codec.decode('manual.that.tools.standard'),
          'manual.that.tools.standard',
        );
        expect(
          codec.decode('discover.OASIS-versions.has.compatibility-embedded'),
          'discover.OASIS-versions.has.compatibility-embedded',
        );
        expect(
          codec.decode('browsers:DOM:both.chain:the:recommending.C'),
          'browsers:DOM:both.chain:the:recommending.C',
        );
        expect(
          codec.decode('methods.profiles.ensure_manipulate.b'),
        ...
        expect(
          codec.decode('related_implementation-security.capabilities:that'),
          'related_implementation-security.capabilities:that',
        );
        expect(
          codec.decode('The-of_files.for.Recommendation-appropriate-disco'),
          'The-of_files.for.Recommendation-appropriate-disco',
        );
        expect(
          codec.decode('cross-over.related.ambiguities-The.Ex'),
        ...
        expect(
          codec.decode('object_rapid.of:partners:including.docume'),
          'object_rapid.of:partners:including.docume',
        );
        expect(
          codec.decode('define.a:Schemas-OASIS:working.Conference_profi'),
    ...
    group('encoder', () {
      ...
      test('should encode NIST provided examples', () {
        expect(
          codec.encode('under.the_digital-among-calle'),
          'under.the_digital-among-calle',
        );
        expect(
          codec.encode('and_is_that_use:issues:data.t'),
          'and_is_that_use:issues:data.t',
        );
        expect(
          codec.encode('is-OASIS.of_related_wide-file'),
          'is-OASIS.of_related_wide-file',
        );
        expect(
          codec.encode('and_and-design-defines_first_'),
          'and_and-design-defines_first_',
        );
        expect(
          codec.encode('and_operating:and.effectively'),
          'and_operating:and.effectively',
        );
        expect(
          codec.encode('Internet_will:_that:to_mad'),
          'Internet_will:_that:to_mad',
        );
        expect(
          codec.encode('launching.correctness_revisions_and.sp'),
          'launching.correctness_revisions_and.sp',
        );
        expect(
          codec.encode('computing-NSRL.can:a.to-of:must-perv'),
          'computing-NSRL.can:a.to-of:must-perv',
        );
        expect(
          codec.encode('that.cost_Business-for_are:industries:processes_pico-'),
          'that.cost_Business-for_are:industries:processes_pico-',
        );
        expect(
          codec.encode(
        ...
        expect(
          codec.encode('led:back:must.ITL_applications:excha'),
          'led:back:must.ITL_applications:excha',
        );
        expect(
          codec.encode(
        ...
        expect(
          codec.encode('cost:on:and_available-will.to:must.tune:creati'),
          'cost:on:and_available-will.to:must.tune:creati',
        );
        expect(
          codec.encode(
        ...
        expect(
          codec.encode('needed:as-is.Furthermore_retrieve-to.means.find'),
          'needed:as-is.Furthermore_retrieve-to.means.find',
        );
        expect(
          codec.encode('the_United-development-and-each-disco'),
          'the_United-development-and-each-disco',
        );
        ...
        expect(
          codec.encode('than:business:ebXML-of:for.of_electronic.diagnosti'),
          'than:business:ebXML-of:for.of_electronic.diagnosti',
        );
        expect(
          codec.encode('manual.that.tools.standard'),
          'manual.that.tools.standard',
        );
        expect(
          codec.encode('discover.OASIS-versions.has.compatibility-embedded'),
          'discover.OASIS-versions.has.compatibility-embedded',
        );
        expect(
          codec.encode('browsers:DOM:both.chain:the:recommending.C'),
          'browsers:DOM:both.chain:the:recommending.C',
        );
        expect(
          codec.encode('methods.profiles.ensure_manipulate.b'),
          'methods.profiles.ensure_manipulate.b',
        );
        ...
        expect(
          codec.encode('related_implementation-security.capabilities:that'),
          'related_implementation-security.capabilities:that',
        );
        expect(
          codec.encode('The-of_files.for.Recommendation-appropriate-disco'),
          'The-of_files.for.Recommendation-appropriate-disco',
        );
        expect(
          codec.encode('cross-over.related.ambiguities-The.Ex'),
          'cross-over.related.ambiguities-The.Ex',
        );
        ...
        expect(
          codec.encode('object_rapid.of:partners:including.docume'),
          'object_rapid.of:partners:including.docume',
        );
        expect(
          codec.encode('define.a:Schemas-OASIS:working.Conference_profi'),
          'define.a:Schemas-OASIS:working.Conference_profi',
        );
      });
    });
