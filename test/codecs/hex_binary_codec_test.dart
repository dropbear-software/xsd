  ...
  group('XsdHexbinaryCodec', () {
    ...
    group('decoder (xsd:hexBinary)', () {
      ...
      test('should handle values defined in the NIST test suite', () {
        ...
        expect(
          codec.decode(
            '696b70746c7777656b6b686b786961737561746a6a666262646161666e617376626b6d70796c6f72786d66786d70657267706971746966636f',
          ),
          isA<Uint8List>(),
        );
        expect(
          codec.decode(
            '70796171746777756779647270757175746f6177636a77647766786e6e626a6c6474796c656f666874',
          ),
          isA<Uint8List>(),
        );
        ...
        expect(
          codec.decode(
            '687873626a6373726f7171677270677771676c6566746b687268797867736d62716763736d6b746474686b696a7772686167676671766a6a676e6869667670796a667078726368',
          ),
          isA<Uint8List>(),
        );
        ...
        expect(
          codec.decode(
            '78787167726d70666773646363637167666a76716c746d65746265786f68666e706b6972696f7071776e626975656c767661636e756a6a6962617261',
          ),
          isA<Uint8List>(),
        );
        expect(
          codec.decode(
            '6b68796c66626a647371616e797170636e636d6973736677706272676a746b',
          ),
          isA<Uint8List>(),
        );
        expect(
          codec.decode(
            '776a6b6e6c796261626e627468767771716577787967636c706c6166',
          ),
          isA<Uint8List>(),
        );
        expect(
          codec.decode(
            '727172736a736b646368616575787074747667686c72746869626667767662746a76636d64786b62646a646e797068617567697063706a776674796b',
          ),
          isA<Uint8List>(),
        );
        ...
        expect(
          codec.decode(
            '7772796b687870626e75736e68796966656372706b6373657064726e65706170766177716e61746263727777747361706577',
          ),
          isA<Uint8List>(),
        );
        expect(
          codec.decode('7871646d6161686f6a747877697365686c67616d616171'),
          isA<Uint8List>(),
        );
        expect(
          codec.decode(
            '6762736c6268707277727578686b75736d6b6873656e736970687664776d786576786d62637465716d79',
          ),
          isA<Uint8List>(),
        );
        expect(
        ...
        expect(
          codec.decode(
            '66656a78736c737670696577636f6f7374736e666f716b6b6d70706372636670756376717174637271636f766174716877676c7677616b6b616b66686b796e6e',
          ),
          isA<Uint8List>(),
        );
        expect(
          codec.decode('716f6a676d716c6a7962627064746c6d6f6b'),
          isA<Uint8List>(),
        );
        expect(
          codec.decode(
        ...
        expect(
          codec.decode('736967716f73666c706f79716e68676764696378'),
          isA<Uint8List>(),
        );
        expect(
          codec.decode(
            '6a75666c716d666b72696c706e6173787067617568747268616a6166637973716a716e72766a62616864706a73616f6e686873666465716d726f64',
          ),
          isA<Uint8List>(),
        );
        expect(
          codec.decode(
            '64756572756677727068687376727365796679757174776b6c67686b656f67657570797976',
          ),
          isA<Uint8List>(),
        );
        ...
        expect(
          codec.decode(
            '6b64636963626276647477686f706770756a7068776870696c62746a63786f6b6e6a746672626c63637376776c6b73786e6b7372616266616875646175646f6167656f636e63697274',
          ),
          isA<Uint8List>(),
        );
        expect(
        ...
        expect(
          codec.decode(
            '6873616774666a696269777162716f78766863727777797765656f74',
          ),
          isA<Uint8List>(),
        );
        expect(
          codec.decode('63696877766e6a636270666f696c72686a'),
          isA<Uint8List>(),
        );
        expect(
          codec.decode(
            '7561656b6979666475666e726d737662746c626d776a77766978676563646c6a6c6b6a7977716b686c7062616a6b716367',
          ),
          isA<Uint8List>(),
        );
        expect(
        ...
        expect(
          codec.decode(
            '6d6f63686e7463706a67747172716b75656966746273697579687666706c6c72726e69706f6b67716d766f626b6c757171777363796b646e666468736f6f6b696464',
          ),
          isA<Uint8List>(),
        );
        expect(
        ...
        expect(
          codec.decode(
            '657575657662737270776a626a70716d6878796e77627878647167786c6862657867796576686d6c63696567787261666d',
          ),
          isA<Uint8List>(),
        );
        expect(
          codec.decode('6f6b66687469687477677775706a61'),
          isA<Uint8List>(),
        );
        expect(
          codec.decode(
            '646f76676367746c6e6d636663696670796a6f616e6862676b656c786275666975616472687463706d77',
          ),
          isA<Uint8List>(),
        );
        expect(
          codec.decode(
            '6b696767676c64707177726b77777865796d63656b6b6369626a66646d6d72676877707162786765757471706c75796c6b75676b6561756b6579706c647269696c766e',
          ),
          isA<Uint8List>(),
        );
        expect(
          codec.decode('776f64796e716c686d78776666626c6f'),
          isA<Uint8List>(),
        );
        expect(
          codec.decode(
            '726565637367796b6d77696d66716c6e6a63757375716d6568676179667674757561766a686e6c7161756664676271676c626f63656c626c7261767168796c747265786b',
          ),
          isA<Uint8List>(),
        );
      });
